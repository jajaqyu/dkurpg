...
스테이지3: 건축학과를 배경으로 하는 스테이지로 파란색 글라임이 적으로 등장하며 클리어시 방어력 증가
...
![easyme](./image/타자연습 미니게임.png)  
### 간단한 퀴즈
화면에 나오는 문제의 정답을 골라야한다.
![easyme](./image/계산 미니게임.png)  